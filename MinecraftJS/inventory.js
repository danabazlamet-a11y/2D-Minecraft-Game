...
function itemClick() {
   ...
   */
    ...
    const blockAbove = grid.children[index - 20]; // لأن عندك 20 عمود

    const hasTreeAbove = blockAbove && blockAbove.classList.contains('wood');
    ...
    else if (currentBlockType === 'grass' && !hasTreeAbove) {
        grassCounter++;
        grassCnt.textContent = grassCounter;
        updateclass(this, 'grass', 'sky');
    }
